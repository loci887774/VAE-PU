...
config = {
    ...
    'n_input': 1024, 'n_hidden_vae_e': [500, 500], 'n_h_y' : 100, 'n_h_o' : 100, 'n_hidden_vae_d': [500, 500], 'n_o': 2,
    'n_hidden_nevae_e' : [50], 'n_z': 50, 'n_hidden_nevae_d': [50], 'n_hidden_disc': [256], 'n_hidden_cl': [],  'n_hidden_pn': [300, 300, 300, 300],
    'alpha_gen': 1, 'alpha_disc': 1 , 'alpha_vae': 1., 'alpha_cl': 1., 'alpha_ne': 1., 'alpha_mi' : 1., 'alpha_o' : 1., 'alpha_vade' : 1., 'alpha_gen2': 3.5, 'alpha_disc2':7,
